    ...
    xmlhttp.onreadystatechange=function(){
     if (xmlhttp.readyState === 4) {
         if (xmlhttp.status === 200) {
          ...
          document.getElementById("Name").innerHTML =my_JSON_object.name;
          document.getElementById("SurName").innerHTML =my_JSON_object.surname;
          } else {
