...
public class QuizBean implements Serializable {
     ...
     private final ArrayList<Problem> problems = new ArrayList<Problem>(Arrays.asList(
             new Problem(
             ...
             //                     "Oak"),
             new Problem(
                     "Which java.util class describes a point in time?", "Date")
     ));
